                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Usuário</label>
                                                        <input type="text" class="form-control" disabled placeholder="Username" value="marcos01">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>RA</label>
                                                        <input type="text" class="form-control" disabled placeholder="RA" value="202912345">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="content">
                                        <div class="author">
                                            <a href="#">
                                                ...
                                                <h4 class="title">Marcos Cavalhieri<br />
                                                    <small>marcos01</small>
                                                </h4>
                                            </a>
                                        </div>
                                        <br>
                                        <p class="description text-center"> Curso: Ciência da Computação  <br>
                                            Email:<a href=""> macavalhieri@anhembimorumbi.edu.br</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
